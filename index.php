  ...
  <main id="app"
    ...
    <template x-if="currentRoute.startsWith('/admin')">
      <div class="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full">
        ...
        <div class="flex overflow-x-auto gap-2 pb-2 mb-6 custom-scrollbar" style="scrollbar-width: none;">
          ...
          <a href="#/admin/live-challenges" @click.prevent="navigate('/admin/live-challenges')" :class="currentRoute==='/admin/live-challenges' ? 'bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-300' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700'" class="px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap transition-colors">📡 Challenge Live</a>
        </div>
        ...
        <div x-show="currentRoute === '/admin/live-challenges'"><?php include 'pages/admin-live-challenges.html'; ?></div>
